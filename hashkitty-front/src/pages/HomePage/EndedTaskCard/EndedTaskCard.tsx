         ...
         <Card>
            <div className="topPart">
               ...
               <div className="showResults">
                  ...
                  />
                  <p className="cardOnStartError">{this.state.onErrorStart}</p>
               </div>
            </div>
            <div className="bottomBox">
               ...
               <div className="cardDeleteButton">
                  <DeleteButton
                     ...
                     handleRefreshAfterDelete={this.props.handleRefreshTasks}
                  />
               </div>
            </div>
   ...
   private renderTaskInfo = () => {
      ...
      return (
         <p>
            {hashTypeName}
            <br />
            {this.props.templateTaskId ? this.props.templateTaskId.name : ''}
            <br />
